    ...
    <>
      <div className="navbar bg-base-100 border-b border-neutral">
        <div className="navbar-start">
          ...
          <a className="btn btn-ghost text-xl">Pokemon</a>
        </div>
      ...
      <footer className="footer footer-center bg-base-300 text-base-content p-4">
        <aside>
          <p>Copyright © <a href="https://andikarekatias.com" target="_blank">Andika Rekatias</a> 2022 - {new Date().getFullYear()}. All rights reserved.</p>
        </aside>
      </footer>
    </>
  );
